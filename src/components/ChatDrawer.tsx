...
//       currentLocation: "Current Location (Google Maps)"
//     },
//     ar: {
//       messages: "الرسائل",
//       product: "منتج",
...
//       currentLocation: "موقعي الحالي (خرائط جوجل)"
//     }
//   };
...
//   // دالة التعامل مع اختيار ورفع الملف إلى R2
...
//             className={`fixed top-0 ${lang === "ar" ? "left-0" : "right-0"} z-[99999] h-full w-full md:w-[400px] bg-white dark:bg-zinc-950 shadow-2xl z-[100] flex flex-col`}
//             dir={lang === "ar" ? "rtl" : "ltr"}
//           >
...
//                               <img
//                                 src={convProduct.images[0]}
//                                 alt={convProduct.title}
//                                 className="w-full h-full object-cover"
//                               />
//                             ) : (
//                               "📦"
...
//                           {/* بيانات المنتج واسم المستخدم */}
//                           <div className="flex flex-col truncate">
//                             <span className="text-xs text-zinc-500">
//                               {participant?.fullName || currentText.user}
//                             </span>
//                             <p className="font-bold text-sm text-black dark:text-white truncate">
//                               {convProduct?.title || currentText.productName}
//                             </p>
//                             <p className="text-xs text-zinc-400 truncate">
//                               {conv.lastMessage || currentText.noMessages}
//                             </p>
//                           </div>
//                         </div>
...
//                             className="flex items-center gap-2 underline font-semibold py-1 px-2 bg-black/10 dark:bg-white/10 rounded-lg"
//                           >
//                             <MapPin size={16} />
//                             <span>{currentText.currentLocation}</span>
//                           </a>
//                         ) : isLink ? (
//                           <a href={m.text} target="_blank" rel="noopener noreferrer" className="underline break-all">
//                             {m.text}
//                           </a>
//                         ) : (
//                           <span>{m.text}</span>
...
//                   {isUploading ? (
//                     <Loader2 size={20} className="animate-spin text-[#232152] dark:text-[#D6C88A]" />
//                   ) : (
...
//                   className={`p-2 rounded-full hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors ${isSharingLocation ? "opacity-50 pointer-events-none" : ""}`}
//                   title={lang === "ar" ? "مشاركة الموقع" : "Share Location"}
//                 >
//                   {isSharingLocation ? (
//                     <Loader2 size={20} className="animate-spin text-[#232152] dark:text-[#D6C88A]" />
//                   ) : (
...
//                   className="flex-1 h-10 px-3 rounded-full border bg-transparent text-sm outline-none" 
//                   placeholder={currentText.typeMessage} 
//                 />

//                 <button 
//                   onClick={handleSend} 
//                   className="bg-[#232152] dark:bg-[#D6C88A] text-white dark:text-black p-2 rounded-full"
//                 >
//                   <Send size={23} />
//                 </button>
//               </div>
